...
export default function SignUpPage() {
  ...
  return (
    <main className="min-h-screen flex items-center justify-center bg-gradient-to-br from-emerald-50 via-teal-50 to-cyan-50 relative overflow-hidden">
      {/* Background Elements */}
      ...
      <div className="absolute top-1/2 left-10 w-24 h-24 bg-cyan-200/30 rounded-full blur-2xl animate-pulse delay-500"></div>
      ...
      <div className="relative w-full max-w-md mx-4">
        ...
        <div className="bg-white/80 backdrop-blur-lg shadow-2xl rounded-3xl p-8 relative overflow-hidden border border-white/20">
          ...
          <div className="text-center mb-6">
            ...
            {/* Trust Indicators */}
            <div className="flex items-center justify-center gap-3 text-xs text-emerald-600/60">
          ...
          <form onSubmit={handleRegister} className="space-y-4">
            {/* Name Field */}
            <div className="group">
              <label className="block text-emerald-700 mb-1 text-sm font-medium">Full Name</label>
              <div className="relative">
                <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  <User className="text-emerald-400 w-4 h-4 group-focus-within:text-emerald-600 transition-colors" />
                </div>
                <input
                  type="text"
            ...
            <button
              type="submit"
              disabled={loading}
              className="group w-full bg-gradient-to-r from-emerald-500 to-teal-500 text-white flex items-center justify-center gap-2 py-3 rounded-xl shadow-lg hover:shadow-xl transform hover:scale-[1.02] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed disabled:transform-none font-medium mt-5"
            >
